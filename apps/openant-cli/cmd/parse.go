...
Supports Python, JavaScript/TypeScript, Go, C/C++, Ruby, PHP, and Rust repositories.
...
func init() {
	...
	parseCmd.Flags().StringVarP(&parseLanguage, "language", "l", "", "Language: python, javascript, go, c, ruby, php, rust, auto")

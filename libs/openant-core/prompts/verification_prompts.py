...
# JSON schema for structured output from native Claude Agent SDK verification.
# Used by FindingVerifier.verify_result via run_native_verification, which
# requests structured_output matching this schema.
...
def get_native_claude_verification_prompt(
    ...
    """
    Verification prompt for native Claude Agent SDK multi-turn mode.
